...
class AuthenticationAppConfig(AppConfig):
    name = 'structure.apps.authentication'
    label = 'authentication'
    verbose_name = 'Authentication'

    def ready(self):
        import structure.apps.authentication.signals
...
default_app_config = 'structure.apps.authentication.AuthenticationAppConfig'
